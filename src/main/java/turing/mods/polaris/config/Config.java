...
public class Config {
    ...
    public static class Builder {
        ...
        public Builder withFolder(String folder) {
            ...
            this.folder = this.folder == null || this.folder.isEmpty() ? folder : this.folder + "/" + folder;
            return this;
        }
        ...
        protected void checkValid() {
            ...
            if (this.folder == null || this.folder.isEmpty()) throw new IllegalArgumentException(String.format("ConfigBuilder must have a valid parent folder! got '%s'", this.folder));
        }
